...
class AccountMove(models.Model):
   ...
   #         "que le dará el receptor del documento.", compute='_compute_folio',
   #    store=True)
   #
   ...
   #         'Tarjeta de Crédito, etc. Deje vacía si no conoce la forma de pago y el XML mostrará "No Identificado".', store=True)
